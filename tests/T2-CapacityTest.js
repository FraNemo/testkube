...
export const options = {
  ...
  //the stop threshold is based on the http request duration. When some raises above 40 seconds,
  // the test is stopped after 5 seconds.
  thresholds: {
    http_req_duration: [
      {
        threshold: 'max<40000', 
...
export function User_Journey1() {
  ...
  resPage = http.post(NAV_URL, {
    ...
    credit_card_number:	"4432-8020-6202-0454",
